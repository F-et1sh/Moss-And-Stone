...
//		m_WindowReference->UnsubscribeOnEvent(EventType::WindowResized,
//							m_EventIndices.at(EventType::WindowResized));
//
//		m_WindowReference->UnsubscribeOnEvent(EventType::MouseMoved,
//							m_EventIndices.at(EventType::MouseMoved));
//
//		m_WindowReference->UnsubscribeOnEvent(EventType::MouseButtonPressed,
//							m_EventIndices.at(EventType::MouseButtonPressed));
//		
//		m_WindowReference->UnsubscribeOnEvent(EventType::MouseButtonReleased,
//							m_EventIndices.at(EventType::MouseButtonReleased));
//		
...
//
//void FE2D::ButtonManager::onWindowResized(const IEvent& e) {
...
//}
//
//void FE2D::ButtonManager::onMouseMoved(const IEvent& e) {
...
//		vec2 button_position = button->m_Position - m_CameraReference->getPosition(); // Shift the Button by the Camera
//
...
//}
//
//void FE2D::ButtonManager::onMouseButtonPressed(const IEvent& e) {
//	if (!m_IsActive) return; // Out from this function if this Button Manager isn't active
//
...
//}
//
//void FE2D::ButtonManager::onMouseButtonReleased(const IEvent& e) {
//	if (!m_IsActive) return; // Out from this function if this Button Manager isn't active
//
