...
#pragma region Set Uniforms without Existing Shader
	...
	// Set vec2 [ ACTIVATE SHADER FIRST ]
	static inline void setUniformVec2(unsigned int shaderRef, const char* uniform_name, vec2  load_uniform)noexcept;
	// Set vec2 Array [ ACTIVATE SHADER FIRST ]
	...
	// Set vec3 [ ACTIVATE SHADER FIRST ]
	static inline void setUniformVec3(unsigned int shaderRef, const char* uniform_name, vec3  load_uniform)noexcept;
	// Set vec3 Array [ ACTIVATE SHADER FIRST ]
	...
	// Set vec4 [ ACTIVATE SHADER FIRST ]
	static inline void setUniformVec4(unsigned int shaderRef, const char* uniform_name, vec4  load_uniform)noexcept;
	// Set vec4 Array [ ACTIVATE SHADER FIRST ]
	...
	// Set mat3 [ ACTIVATE SHADER FIRST ]
	static inline void setUniformMat3(unsigned int shaderRef, const char* uniform_name, mat3  load_uniform)noexcept;
	// Set mat3 Array [ ACTIVATE SHADER FIRST ]
	...
	// Set mat4 [ ACTIVATE SHADER FIRST ]
	static inline void setUniformMat4(unsigned int shaderRef, const char* uniform_name, mat4  load_uniform)noexcept;
	// Set mat4 Array [ ACTIVATE SHADER FIRST ]
