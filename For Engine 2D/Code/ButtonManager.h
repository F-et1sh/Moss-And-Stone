...
//
//	private:
//		void onWindowResized      (const IEvent& e);
//		void onMouseMoved         (const IEvent& e);
//		void onMouseButtonPressed (const IEvent& e);
//		void onMouseButtonReleased(const IEvent& e);
//
//		// Indices to unsubscribe on this events in Release() function
//		std::unordered_map<EventType, EventDispatcher::ListenerID> m_EventIndices;
//
//	public:
