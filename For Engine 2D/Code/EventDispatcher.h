...
namespace FE2D {
    ...
    public:
        ...
        inline const ListenerID& subscribe(const Event::EventType& type, const Listener& listener) {
    ...
    private:
        ...
        std::unordered_map<Event::EventType, std::unordered_map<ListenerID, Listener>> m_Listeners;
    };
}